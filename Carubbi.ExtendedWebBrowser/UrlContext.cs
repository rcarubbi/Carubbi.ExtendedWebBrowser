...
namespace Carubbi.ExtendedWebBrowser
{
    ...
    public enum UrlContext
    {
        ...
        ///     Some pages load pop-up windows when you leave them rather than when you enter. This flag is used to identify those
        ///     situations.
        /// </summary>
        Unloading = 0x1,
        ...
        ///     all pop-up windows to display—and must be held down at the time that INewWindowManager::EvaluateNewWindow is
        ///     called.
        /// </summary>
        OverrideKey = 0x8,

        /// <summary>
        ///     The new window attempting to load is the result of a call to the showHelp method. Help is sometimes displayed in a
        ///     separate window,
