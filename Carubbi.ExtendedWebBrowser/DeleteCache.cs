...
namespace Carubbi.ExtendedWebBrowser
{
    public partial class ExtendedWebBrowser
    {
        ...
        public void DeleteCache()
        {
            ...
            var cacheEntryInfoBufferSize = 0;
            var cacheEntryInfoBuffer = IntPtr.Zero;
            ...
            {
                internetCacheEntry =
                    (INTERNET_CACHE_ENTRY_INFOA) Marshal.PtrToStructure(cacheEntryInfoBuffer,
                        typeof(INTERNET_CACHE_ENTRY_INFOA));
                ...
                if (!returnValue && ERROR_NO_MORE_ITEMS == Marshal.GetLastWin32Error()) break;
